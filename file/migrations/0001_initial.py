# Generated by Django 2.2.2 on 2020-03-08 06:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='file.Archivo')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_estado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='estado', to='file.Estado')),
